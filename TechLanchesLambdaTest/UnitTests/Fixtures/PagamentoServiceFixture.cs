namespace TechLanchesLambdaTest.UnitTests.Fixtures
{
    ...
    {
        private const string MENSAGEM_INATIVAR_USUARIO = "Erro durante chamada api de pagamentos.";
        private const string MENSAGEM_INATIVAR_USUARIO_EXCECAO = "Falha ao ler arquivo string da api/pagamentos/inativar";
